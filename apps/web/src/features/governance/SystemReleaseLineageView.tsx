...
export const SystemReleaseLineageView: React.FC<SystemReleaseLineageViewProps> = ({
  ...
  return (
    <div style={{ padding: '24px', backgroundColor: '#0f172a', color: '#f8fafc', borderRadius: '12px', marginTop: '24px' }}>
      ...
      <GovernanceBanner
        mode="snapshot"
        title="Release Certificate Lineage & Evolution"
        description={`DERIVED ANALYTICAL LINEAGE reconstructed from Phase 27 supersedesCertificateId links for ${projectName}.`}
        className="mb-5"
      />
